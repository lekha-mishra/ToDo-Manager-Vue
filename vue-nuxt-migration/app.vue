<template>
  <div id="app">
    ...
    <main class="d-flex flex-row">
      <LeftNavBar />
      <b-container class="pt-3 pb-5" style="min-height: calc(100vh - 54px)">
        <ToDoList />
      </b-container>
    </main>
  </div>
...
import LeftNavBar from "./src/components/LeftNavBar.vue";
import ToDoList from "./src/components/ToDoList.vue";

export default {
  name: "App",
  components: { TopNavBar, LeftNavBar, ToDoList },
};
</script>
